...
**Last updated:** 2026-05-23 — Maxxer frontend shipped on `feature/social` (ChatPanel, OnboardingChat, [EVENT:id] parser, mock adapter, suggestion plumbing). Awaits Dev 1's `/api/chat` + `/api/chat/onboarding` for real agent responses.
