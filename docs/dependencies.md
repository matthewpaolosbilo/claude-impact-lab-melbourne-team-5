...
**Last updated:** 2026-05-23 (3.4 shipped on branch `feat-3.4`)
...
- [Dev 3 — Frontend Foundation](dev3-dependencies.md) — Critical path: `3.3 → 3.8 → 3.9 → 3.10 → 3.15` (five tasks; 3.1, 3.2, 3.4, 3.13 already ✅ DONE).
